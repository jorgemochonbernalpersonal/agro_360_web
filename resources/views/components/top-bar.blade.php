        ...
        <div class="flex items-center space-x-3 lg:space-x-6">
            ...
            <div x-data="{ open: false }" @click.away="open = false" class="relative">
                ...
                >
                    ...
                    <a href="{{ route('config.index') }}" wire:navigate class="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-[var(--color-agro-green-bg)] hover:text-[var(--color-agro-green-dark)] transition-colors duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
