...
<head>
    ...
    <title>Verifica tu Email - Agro365</title>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="px-6 py-5">
                ...
                <div class="text-center mb-6">
                    ...
                    <h1 class="text-xl font-semibold text-zinc-800">Verifica tu Email</h1>
                    <p class="mt-1 text-sm text-zinc-500">Revisa tu bandeja de entrada</p>
                </div>
                ...
                @else
                    <p class="text-sm text-zinc-600 text-center mb-6">
                        Gracias por registrarte. Hemos enviado un enlace de verificación a
                ...
                <div class="mt-6 pt-5 border-t border-zinc-100 flex items-center justify-between">
                    <p class="text-xs text-zinc-400">¿No lo ves? Revisa tu carpeta de spam.</p>
