...
<body class="font-sans antialiased bg-white">
    ...
    <div class="min-h-screen bg-gradient-to-b from-white to-gray-50 py-20">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="text-sm text-gray-500 mb-8">
                ...
                <span>{{ __('Calendario Vitícola 2025') }}</span>
            </nav>
            ...
            <article class="prose prose-lg max-w-none">
                ...
                <div class="space-y-6">
                    <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-blue-400">
                        <h3 class="font-bold text-xl text-[var(--color-agro-green-dark)]">{{ __('❄️ Enero - Febrero') }}</h3>
                        <p class="text-gray-600 text-sm mb-2">{{ __('Reposo invernal') }}</p>
                        <ul class="text-gray-700 space-y-1">
                            <li>• <strong>{{ __('Poda en seco') }}</strong> - Principal labor del invierno</li>
                            <li>{{ __('• Reparación de estructuras (espalderas, alambres)') }}</li>
                            <li>{{ __('• Análisis de suelo') }}</li>
                            <li>{{ __('• Planificación de la campaña') }}</li>
                        </ul>
                    </div>

                    <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-green-400">
                        <h3 class="font-bold text-xl text-[var(--color-agro-green-dark)]">{{ __('🌱 Marzo - Abril') }}</h3>
                        <p class="text-gray-600 text-sm mb-2">{{ __('Brotación') }}</p>
                        <ul class="text-gray-700 space-y-1">
                            <li>{{ __('• Lloro de la vid (savia en heridas de poda)') }}</li>
                            <li>• <strong>{{ __('Brotación') }}</strong> - Inicio del ciclo vegetativo</li>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-pink-400">
                        <h3 class="font-bold text-xl text-[var(--color-agro-green-dark)]">{{ __('🌸 Mayo - Junio') }}</h3>
                        <p class="text-gray-600 text-sm mb-2">{{ __('Floración y cuajado') }}</p>
                        <ul class="text-gray-700 space-y-1">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-amber-400">
                        <h3 class="font-bold text-xl text-[var(--color-agro-green-dark)]">{{ __('☀️ Julio - Agosto') }}</h3>
                        <p class="text-gray-600 text-sm mb-2">{{ __('Envero y maduración') }}</p>
                        <ul class="text-gray-700 space-y-1">
                            <li>• <strong>{{ __('Envero') }}</strong> - Cambio de color de las bayas</li>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-purple-400">
                        <h3 class="font-bold text-xl text-[var(--color-agro-green-dark)]">{{ __('🍇 Septiembre - Octubre') }}</h3>
                        <p class="text-gray-600 text-sm mb-2">{{ __('Vendimia') }}</p>
                        <ul class="text-gray-700 space-y-1">
                            <li>{{ __('• Control de maduración (Baumé, acidez, pH)') }}</li>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-orange-400">
                        <h3 class="font-bold text-xl text-[var(--color-agro-green-dark)]">{{ __('🍂 Noviembre - Diciembre') }}</h3>
                        <p class="text-gray-600 text-sm mb-2">{{ __('Post-vendimia') }}</p>
                        <ul class="text-gray-700 space-y-1">
                ...
                <div class="bg-gradient-to-r from-[var(--color-agro-green-bg)] to-[var(--color-agro-green-light)]/30 p-8 rounded-xl border border-[var(--color-agro-green)]/20 mt-12">
                    <h3 class="text-xl font-bold text-[var(--color-agro-green-dark)] mb-4">{{ __('📅 Organiza tu campaña 2025') }}</h3>
                    <p class="text-gray-700 mb-6">
                        Calendario integrado con cuaderno de campo y recordatorios. <strong>{{ __('3 meses gratis') }}</strong>.
                    </p>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Calendario vitícola 2025 completo: todas las labores del viñedo organizadas por mes. Poda, tratamientos, floración, envero, vendimia y más.",
