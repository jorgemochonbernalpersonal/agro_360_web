    ...
    <div class="space-y-6 animate-fade-in">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <x-feature-card
                ...
                title="Parcelas"
                description="Gestiona y visualiza todas las parcelas del sistema con información completa"
            ...
            <x-feature-card
                ...
                title="Plantaciones"
                description="Consulta y analiza las plantaciones de variedades en las parcelas"
                icon-gradient="from-[var(--color-agro-green-light)] to-[var(--color-agro-green)]"
            />
            ...
            <x-feature-card
                ...
                title="SIGPACs"
                description="Administra datos SIGPAC, coordenadas y registros geográficos"
            ...
            <x-feature-card
                ...
                title="Configuración"
                description="Ajusta preferencias, usuarios y configuraciones avanzadas"
