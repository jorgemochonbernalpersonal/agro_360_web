<x-agro.form-card
    title="Editar Control de Fermentación"
    description="Modifica los parámetros registrados del control."
    icon="beaker"
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-actions :back-url="roleRoute('fermentation-controls.index')" submit-label="Actualizar control" />
    </form>
</x-agro.form-card>
