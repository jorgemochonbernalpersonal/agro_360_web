                    ...
                    >
                        ...
                        <x-slot:footer>
                            <div class="flex items-center justify-end gap-0.5">
                                <x-agro.action-button icon="pencil" variant="default" href="{{ roleRoute('labeling.edit', $labeling) }}" wire:navigate title="Editar" />
                                <x-agro.action-button variant="delete" wire:click="delete({{ $labeling->id }})" wire:confirm="¿Eliminar esta sesión? Se devolverán las etiquetas al lote." title="Eliminar" />
                            </div>
                        </x-slot:footer>
                    </x-agro.card>
                @endforeach
