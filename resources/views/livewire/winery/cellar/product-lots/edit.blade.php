<div>
    <x-agro.form-card title="{{ __('Editar Producto') }}" :description="__('Modifica los datos del producto')"
        ...
        <div x-data="{ tab: 'general' }">
            <form wire:submit.prevent="save" class="space-y-0">
                ...
                <x-agro.form-actions :cancel-url="roleRoute('product-lots.index')" submit-:label="__('Guardar Cambios')" />
