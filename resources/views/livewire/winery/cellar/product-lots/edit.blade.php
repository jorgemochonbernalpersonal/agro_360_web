            ...
            <x-agro.form-section title="Analíticos">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <flux:field>
                        ...
                        <flux:input wire:model="residual_sugar" type="number" step="0.01" min="0" id="residual_sugar" />
                        <flux:error name="residual_sugar" />
                    </flux:field>

                    <flux:field>
                        <flux:label for="total_acidity">Acidez total (g/L)</flux:label>
                        <flux:input wire:model="total_acidity" type="number" step="0.01" min="0" id="total_acidity" />
                        <flux:error name="total_acidity" />
                    </flux:field>

                    <flux:field>
                        <flux:label for="volatile_acidity">Acidez volátil (g/L)</flux:label>
                        <flux:input wire:model="volatile_acidity" type="number" step="0.01" min="0" id="volatile_acidity" />
                        <flux:error name="volatile_acidity" />
                    </flux:field>

                    <flux:field>
                        <flux:label for="ph">pH</flux:label>
                        <flux:input wire:model="ph" type="number" step="0.01" min="0" max="14" id="ph" />
                        <flux:error name="ph" />
                    </flux:field>
                </div>
            </x-agro.form-section>
            ...
            <x-agro.form-section title="Viñedo">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <flux:field>
                        ...
                        <flux:input wire:model="vine_age" type="number" id="vine_age" min="0" />
                        <flux:error name="vine_age" />
                    </flux:field>

                    <flux:field>
                        <flux:label for="altitude">Altitud (m.s.n.m.)</flux:label>
                        <flux:input wire:model="altitude" type="number" id="altitude" min="0" />
                        <flux:error name="altitude" />
                    </flux:field>

                    <flux:field class="md:col-span-2">
                        <flux:label for="soil_type">Tipo de suelo</flux:label>
                        <flux:input wire:model="soil_type" type="text" id="soil_type" />
            ...
            <x-agro.form-section title="Elaboración">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <flux:field class="md:col-span-2">
                        ...
                        <flux:input wire:model="fermentation_vessel" type="text" id="fermentation_vessel" />
                        <flux:error name="fermentation_vessel" />
                    </flux:field>

                    <flux:field>
                        <flux:label for="oak_type">Tipo de barrica</flux:label>
                        <flux:input wire:model="oak_type" type="text" id="oak_type" />
            ...
            <x-agro.form-section title="Producción y Premios">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <flux:field>
                        ...
                        <flux:input wire:model="production_quantity" type="number" id="production_quantity" min="0" />
