<x-agro.form-card
    :title="__('Nueva Operación') . ' — ' . $wine->name"
    :description="__('Registra una etapa del proceso de vinificación.')"
    icon="arrow-path"
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-actions :back-url="roleRoute('wines.edit', $wine)" submit-:label="__('Guardar operación')" />
    </form>
</x-agro.form-card>
