    ...
    <x-agro.form-card title="Nueva Factura de Productos" description="Crea una factura de venta de productos a un cliente"
        ...
        <form wire:submit.prevent="save" class="space-y-8">
            ...
            <x-agro.form-section title="Datos de la Factura">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <flux:field>
                        ...
                        @if ($clients->isEmpty())
                            <flux:description>
                                <a href="{{ route('winery.clients.create') }}" class="text-primary-600 underline">Crea tu primer cliente</a>
                            </flux:description>
                        @endif
                    </flux:field>
            ...
            <x-agro.form-section title="Observaciones">
                <flux:field>
                    <flux:textarea wire:model="observations" id="observations" rows="3" placeholder="Observaciones para la factura..." />
                </flux:field>
            </x-agro.form-section>

            <x-agro.form-actions :cancel-url="route('winery.invoices.wine-sale.index')" submit-label="Crear Factura" />
        </form>
    </x-agro.form-card>
</div>
