<x-agro.form-card
    title="{{ __('Nueva Campaña de Vendimia') }}"
    :description="__('Define el periodo y nombre de la campaña para agrupar tus recepciones de uva')"
