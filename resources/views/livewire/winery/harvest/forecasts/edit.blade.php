<div class="space-y-6 animate-fade-in">
    ...
    >
        <x-slot:actions>
            <flux:button variant="ghost" icon="arrow-left" href="{{ route('winery.harvest-forecasts.index') }}" wire:navigate>
                Volver
            </flux:button>
        </x-slot:actions>
    </x-agro.page-header>
    ...
    <x-agro.form-card>
        ...
        <x-agro.form-actions>
            <flux:button type="submit" variant="primary" wire:click="save" wire:loading.attr="disabled">
                Guardar cambios
            </flux:button>
            <flux:button variant="ghost" href="{{ route('winery.harvest-forecasts.index') }}" wire:navigate>
                Cancelar
            </flux:button>
        </x-agro.form-actions>
