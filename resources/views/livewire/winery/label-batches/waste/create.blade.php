    ...
    <form wire:submit="save" class="space-y-8">
        <x-agro.form-section title="Datos de la merma" color="red">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <flux:field>
                    <flux:label required>Cantidad de etiquetas</flux:label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                <flux:field>
                    <flux:label>Número desde</flux:label>
                    <flux:input wire:model="from_number" type="number" min="0" placeholder="Opcional" />
                    <flux:error name="from_number" />
                </flux:field>

                <flux:field>
                    <flux:label>Número hasta</flux:label>
                    <flux:input wire:model="to_number" type="number" min="0" placeholder="Opcional" />
                    <flux:error name="to_number" />
                </flux:field>
            </div>
        </x-agro.form-section>

        <x-agro.form-section title="Motivo" color="zinc">
            <flux:field>
                <flux:label>Descripción de la merma</flux:label>
                <flux:textarea wire:model="reason" rows="3"
                    placeholder="Ej. Etiquetas dañadas en almacén, error de impresión, retirada por DO..." />
