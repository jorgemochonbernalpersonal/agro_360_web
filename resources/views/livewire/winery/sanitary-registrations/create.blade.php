<x-agro.form-card
    title="{{ __('Nuevo Registro Sanitario') }}"
    :description="__('Registra un nuevo registro sanitario de la bodega.')"
    icon="shield-check"
...
>
    <form wire:submit="save" class="space-y-8">
        <x-agro.form-section title="{{ __('Identificación') }}" color="teal">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <flux:field>
                    ...
                    <flux:input wire:model="registration_number" type="text" :placeholder="__('Ej. ES-MA-0001234/A')" required />
                ...
                <flux:field class="md:col-span-2">
                    ...
                    <flux:input wire:model="activity_description" type="text" :placeholder="__('Descripción de la actividad registrada')" />
                    <flux:error name="activity_description" />
                </flux:field>

                <flux:field>
                    <flux:label>{{ __('Organismo emisor') }}</flux:label>
                    <flux:input wire:model="issuing_authority" type="text" :placeholder="__('Ej. AESAN, CCAA...')" />
        ...
        <x-agro.form-actions :cancel-url="roleRoute('sanitary-registrations.index')" :submit-label="__('Guardar registro')" />
    </form>
</x-agro.form-card>
