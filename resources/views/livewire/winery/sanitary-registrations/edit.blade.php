<x-agro.form-card
    ...
    description="Modifica los datos del registro sanitario."
    icon="shield-check"
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-actions :back-url="roleRoute('sanitary-registrations.index')" submit-label="Actualizar registro" />
    </form>
</x-agro.form-card>
