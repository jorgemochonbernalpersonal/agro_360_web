<x-agro.form-card
    title="Nuevo Trasvase / Coupage"
    description="Registra un movimiento de vino entre depósitos: trasiego, mezcla o relleno."
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-actions :back-url="roleRoute('wine-transfers.index')" submit-label="Guardar trasvase" />
    </form>
</x-agro.form-card>
