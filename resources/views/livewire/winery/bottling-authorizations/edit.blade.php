<x-agro.form-card
    title="Editar Autorización de Embotellado"
    description="Modifica los datos de la autorización de embotellado."
    icon="identification"
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-actions :back-url="roleRoute('bottling-authorizations.index')" submit-label="Actualizar autorización" />
    </form>
</x-agro.form-card>
