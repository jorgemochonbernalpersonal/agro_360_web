<x-agro.form-card
    title="{{ __('Nuevo Análisis de Laboratorio') }}"
    :description="__('Registra los resultados de un análisis fisicoquímico.')"
    icon="beaker"
        ...
        <x-agro.form-section title="{{ __('Identificación') }}" color="purple">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <flux:field>
                    ...
                    <flux:input wire:model="laboratory" type="text" :placeholder="__('Nombre del laboratorio')" />
                    <flux:error name="laboratory" />
                </flux:field>

                <flux:field>
                    <flux:label>{{ __('Referencia de muestra') }}</flux:label>
                    <flux:input wire:model="sample_reference" type="text" :placeholder="__('Ej. M-2026-001')" />
        ...
        <x-agro.form-section title="{{ __('Notas') }}" color="zinc">
            <flux:field>
                ...
                <flux:textarea wire:model="notes" rows="3"
                    placeholder="{{ __('Comentarios adicionales sobre el análisis...') }}" />
