<x-agro.form-card
    title="Editar Análisis de Laboratorio"
    description="Modifica los datos del análisis fisicoquímico."
    icon="beaker"
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-actions :back-url="roleRoute('wine-analysis.index')" submit-label="Actualizar análisis" />
    </form>
</x-agro.form-card>
