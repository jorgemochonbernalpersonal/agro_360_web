<x-agro.form-card
    title="Editar Certificación Ecológica"
    description="Modifica los datos de la certificación ecológica."
    icon="sparkles"
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-actions :back-url="roleRoute('eco-certifications.index')" submit-label="Actualizar certificación" />
    </form>
</x-agro.form-card>
