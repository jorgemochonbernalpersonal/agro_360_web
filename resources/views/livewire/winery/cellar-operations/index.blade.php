                ...
                >
                    ...
                    <x-slot:footer>
                        <div class="flex items-center justify-end gap-0.5">
                            <x-agro.action-button icon="pencil" variant="default" href="{{ roleRoute('cellar-operations.edit', $operation) }}" wire:navigate title="Editar" />
                            <x-agro.action-button variant="delete" wire:click="delete({{ $operation->id }})" wire:loading.attr="disabled" wire:confirm="¿Eliminar esta operación?" title="Eliminar" />
                        </div>
                    </x-slot:footer>
                </x-agro.card>
            @endforeach
