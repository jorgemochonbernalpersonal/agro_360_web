<x-agro.form-card
    title="Nueva Operación de Bodega"
    description="Registra un trasiego, clarificación, filtración u otra operación enológica."
    icon="calendar-days"
        ...
        <x-agro.form-section title="Responsable y Notas" color="green">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <flux:field>
                    ...
                    <flux:input wire:model="responsible_person" type="text" placeholder="Nombre del responsable" />
            ...
            <div class="mt-4">
                <flux:field>
                    ...
                    <flux:textarea wire:model="notes" rows="3" placeholder="Observaciones, condiciones, resultados..." />
                    <flux:error name="notes" />
                </flux:field>
            </div>
        </x-agro.form-section>

        <x-agro.form-actions :back-url="roleRoute('cellar-operations.index')" submit-label="Guardar operación" />
    </form>
</x-agro.form-card>
