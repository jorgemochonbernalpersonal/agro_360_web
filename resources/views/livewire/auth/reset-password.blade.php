        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            @if(session('error'))
                <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-600 rounded-lg">
                    <p class="text-sm font-semibold text-red-800 mb-2">{{ session('error') }}</p>
                    <a href="{{ route('password.request') }}" class="inline-block text-sm text-red-600 hover:underline font-medium">
