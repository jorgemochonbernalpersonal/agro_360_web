        ...
        <x-form-section title="Información Básica" color="green">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <x-input wire:model="name" type="text" id="name" :error="$errors->first('name')" required />
                </div>

                <!-- Área -->
                <div>
                    <x-label for="area">Área (hectáreas)</x-label>
                    <x-input wire:model="area" type="number" step="0.001" id="area" :error="$errors->first('area')" />
                </div>
            </div>
            ...
            <div class="mt-6">
                ...
                <x-textarea wire:model="description" id="description" rows="3" :error="$errors->first('description')" />
            </div>
        ...
        <x-form-section title="Ubicación" color="green">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <x-select wire:model.live="province_id" id="province_id" :error="$errors->first('province_id')"
                ...
                <div>
                    ...
                    <x-select wire:model.live="municipality_id" id="municipality_id"
