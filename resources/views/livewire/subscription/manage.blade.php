                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="border-2 rounded-xl p-6 cursor-pointer transition-all 
                            {{ $selectedPlan === 'monthly' ? 'border-[var(--color-agro-green)] bg-green-50' : 'border-gray-300' }}"
                        ...
                        <div class="border-2 rounded-xl p-6 cursor-pointer transition-all relative
                            {{ $selectedPlan === 'yearly' ? 'border-[var(--color-agro-green)] bg-green-50' : 'border-gray-300' }}"
