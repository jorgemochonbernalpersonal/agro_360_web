    ...
    @if($show)
        <div x-data="{ expanded: false }" class="mb-4">
            ...
            <div @click="expanded = !expanded"
                 class="bg-gradient-to-r from-agro-50 to-purple-50 rounded-lg border border-agro-200 p-3 cursor-pointer hover:shadow-md transition-all">
            ...
            {{-- Expanded Content --}}
            <div x-show="expanded" x-collapse class="mt-2 bg-white rounded-lg border border-zinc-200 p-4">
