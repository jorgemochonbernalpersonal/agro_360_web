<div class="space-y-6 animate-fade-in">
    ...
    <x-agro.card :padding="false">
        <div class="px-6 py-5">
            <x-agro.tabs
                :tabs="['general' => __('General'), 'taxes' => __('Impuestos'), 'invoicing' => __('Numeración'), 'fiscal' => __('Datos Fiscales'), 'fieldbook' => __('Cuaderno de Campo'), 'signature' => __('Firma Digital')]"
                :active="$currentTab"
            ...
            @if($currentTab === 'general')
                <div class="space-y-6">
                    <div>
                        <h3 class="text-lg font-bold text-zinc-900 mb-2">{{ __('Configuración General') }}</h3>
                        <p class="text-sm text-zinc-600">{{ __('Opciones generales de tu cuenta de productor') }}</p>
                    </div>

                    <div class="p-5 border border-zinc-200 rounded-xl space-y-4">
                        <div class="flex items-start justify-between">
                            <div>
                                <h4 class="font-semibold text-zinc-900">{{ __('Compra de uva externa') }}</h4>
                                <p class="text-sm text-zinc-500 mt-1">
                                    {{ __('Activa esta opción si compras uva a viticultores externos ademas de producir la tuya propia. Esto habilita la gestion de viticultores, aforos, disputas y avisos.') }}
                                </p>
                            </div>
                        ...
                        @if($compra_uva_externa)
                            <div class="flex items-center gap-2 p-3 bg-agro-50 rounded-lg">
                                ...
                                <p class="text-sm text-agro-800">
                                    {{ __('Modulos activos: Mis Viticultores, Aforos, Disputas, Avisos a Viticultores. Accede desde el menu lateral.') }}
                                </p>
                            </div>
                        @endif
                    </div>
                    ...
                    <flux:callout variant="warning" icon="exclamation-triangle">
                        ...
                        <flux:callout.text>
                            ...
                            <p class="mt-3 text-xs">
                                ...
                                <a href="{{ route('producer.official-reports.index') }}" class="underline font-semibold">{{ __('Informes Oficiales') }}</a>.
                            </p>
                        </flux:callout.text>
                    </flux:callout>
                </div>
