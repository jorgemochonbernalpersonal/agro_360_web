        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                <thead class="bg-zinc-50">
                    <tr>
                        <th class="px-4 py-2 text-left text-zinc-600">Fecha</th>
                        <th class="px-4 py-2 text-center text-zinc-600">NDVI</th>
                        <th class="px-4 py-2 text-center text-zinc-600">NDWI</th>
                        <th class="px-4 py-2 text-center text-zinc-600">Estado</th>
                        <th class="px-4 py-2 text-center text-zinc-600">Tendencia</th>
                    </tr>
                </thead>
