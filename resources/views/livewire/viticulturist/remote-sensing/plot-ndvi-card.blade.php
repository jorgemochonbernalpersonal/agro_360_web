<div class="bg-white rounded-lg shadow-lg p-6">
    ...
    @elseif($isLoading)
        <div class="flex items-center justify-center py-8">
            ...
            <span class="ml-2 text-zinc-600">Cargando datos de satélite...</span>
        </div>
    @elseif($latestData)
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-semibold text-zinc-600">Tendencia</span>
            ...
            <div class="bg-gradient-to-br from-purple-50 to-violet-50 rounded-lg p-4 border border-purple-200">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-semibold text-zinc-600">Última imagen</span>
        ...
        <div class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg p-4 border border-amber-200 mb-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-zinc-800">Comparativa vs Año Anterior</h4>
                        <p class="text-xs text-zinc-500">Mismo mes de {{ now()->year - 1 }}</p>
                    </div>
                </div>
        ...
        @if($showChart && count($historicalData) > 0)
            <div class="mt-4 p-4 bg-white border rounded-lg">
                <h3 class="text-sm font-semibold text-zinc-700 mb-3">📈 Evolución NDVI - Últimos 90 días</h3>
    ...
    @else
        <div class="text-center py-8 bg-zinc-50 rounded-lg">
            ...
            <p class="text-zinc-600 mb-2">No hay datos de teledetección disponibles</p>
            <p class="text-sm text-zinc-500">Los datos se generarán automáticamente cuando haya imágenes satelitales disponibles para esta parcela.</p>
        </div>
    @endif
</div>
