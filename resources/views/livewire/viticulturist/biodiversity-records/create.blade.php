<x-agro.form-card
    :title="__('Registrar Biodiversidad')"
    :description="__('Documenta elementos de biodiversidad y cubiertas vegetales para eco-esquemas PAC')"
