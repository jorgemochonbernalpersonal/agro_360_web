<x-agro.form-card
    :title="__('Nueva Alerta Fitosanitaria')"
    :description="__('Registra una alerta fitosanitaria oficial para tu explotación')"
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-section :title="__('Información de la Alerta')">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <flux:field class="md:col-span-2">
                    ...
                    <flux:input wire:model="title" type="text" :placeholder="__('Ej: Alerta por Mildiu en viñedos de la zona')" />
        ...
        <x-agro.form-section :title="__('Detalle')">
            <div class="grid grid-cols-1 gap-6">
                ...
                <flux:field>
                    ...
                    <flux:input wire:model="affected_area" type="text" :placeholder="__('Ej: Parcelas del Valle del Ebro, zona norte')" />
                ...
                <flux:field>
                    ...
                    <flux:textarea
                        ...
                        rows="4"
                        :placeholder="__('Descripción detallada de la alerta: situación, causas, alcance...')"
                    />
                ...
                <flux:field>
                    ...
                    <flux:textarea
                        ...
                        rows="3"
                        :placeholder="__('Medidas preventivas o correctoras recomendadas')"
                    />
        ...
        <x-agro.form-actions
            ...
            :submit-label="__('Registrar Alerta')"
        />
    </form>
</x-agro.form-card>
