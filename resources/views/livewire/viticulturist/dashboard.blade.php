<div class="space-y-6 animate-fade-in">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-5" data-cy="kpi-plots">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-[var(--color-agro-green-dark)]">{{ $this->totalPlots }}</p>
                    <p class="text-xs text-gray-400">{{ number_format($this->totalArea, 1) }} ha</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-5" data-cy="kpi-activities">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-purple-600">{{ $this->activitiesThisMonth }}</p>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-5" data-cy="kpi-harvest">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-amber-600">{{ number_format($this->totalHarvested / 1000, 1) }}</p>
                    <p class="text-xs text-gray-400">toneladas {{ now()->year }}</p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-5" data-cy="seasonal-tip">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
                <h3 class="text-sm font-bold text-gray-900">{{ $this->currentTip['title'] }}</h3>
                <p class="text-xs text-gray-600 mt-1">{{ $this->currentTip['tip'] }}</p>
            </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        @if($this->isNewUser)
            ...
            <a href="{{ route('viticulturist.pac.dashboard') }}" wire:navigate class="relative bg-white rounded-xl shadow border border-gray-200 p-4 hover:shadow-lg hover:border-amber-300 transition-all flex items-center gap-3">
        ...
        @else
            ...
            <a href="{{ route('viticulturist.invoices.harvest-sale.index') }}" wire:navigate class="relative bg-white rounded-xl shadow border border-gray-200 p-4 hover:shadow-lg hover:border-indigo-300 transition-all flex items-center gap-3">
