    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-section title="Datos del Plan" color="green">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                <flux:field>
                    <flux:label for="status" badge="Obligatorio">Estado</flux:label>
        ...
        <x-agro.form-section title="Resumen de Nutrientes" color="amber">
            <p class="text-xs text-zinc-500 mb-4">Opcional. Puedes rellenarlo manualmente o ajustarlo según las parcelas.</p>
        ...
        <x-agro.form-section title="Parcelas del Plan" color="green">
            <p class="text-xs text-zinc-500 mb-4">Parcelas incluidas en el plan con sus dosis de fertilizante.</p>
