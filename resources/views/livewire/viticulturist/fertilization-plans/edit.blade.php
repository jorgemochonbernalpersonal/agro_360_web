<x-agro.form-card
    :title="__('Editar Plan de Fertilización')"
    :description="__('Modifica el plan de fertilización del año') . ' ' . $plan->plan_year"
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-section :title="__('Resumen de Nutrientes')" color="amber">
            <p class="text-xs text-zinc-500 mb-4">{{ __('Opcional. Puedes rellenarlo manualmente o ajustarlo según las parcelas.') }}</p>
        ...
        <x-agro.form-section :title="__('Parcelas del Plan')" color="green">
            <p class="text-xs text-zinc-500 mb-4">{{ __('Parcelas incluidas en el plan con sus dosis de fertilizante.') }}</p>
