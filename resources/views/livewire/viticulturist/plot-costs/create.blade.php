<div>
<x-agro.form-card
    :title="__('Registrar Coste')"
    :description="__('Añade un nuevo coste asociado a una parcela o campaña.')"
...
>
    <form wire:submit.prevent="save" class="space-y-8">
        ...
        <x-agro.form-actions :cancel-url="roleRoute('viticulturist.plot-costs.index')" :submit-label="__('Registrar Coste')" />
    </form>
</x-agro.form-card>
</div>
