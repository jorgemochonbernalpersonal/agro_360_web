<x-agro.form-card
    :title="__('Registrar Consumo Energético')"
    :description="__('Registra el consumo de energía y calcula automáticamente la huella de carbono')"
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-actions
            ...
            :submit-label="__('Registrar Consumo')"
        />
    </form>
</x-agro.form-card>
