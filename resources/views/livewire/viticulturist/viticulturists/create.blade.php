<div class="space-y-6 animate-fade-in">
    ...
    @endphp
    <x-page-header :icon="$icon" title="Crear Viticultor"
        description="Crea un nuevo viticultor para gestionar en tus cuadrillas y parcelas"
        icon-color="from-[var(--color-agro-green)] to-[var(--color-agro-green-dark)]">
        <x-slot:actionButton>
            <x-button href="{{ route('viticulturist.personal.index', ['viewMode' => 'personal']) }}" variant="secondary">
        ...
        <form wire:submit="save" class="space-y-8">
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-input wire:model="name" type="text" id="name" placeholder="Ej: Juan Pérez"
                    ...
                    <div>
                        ...
                        <x-input wire:model="email" type="email" id="email" placeholder="correo@ejemplo.com"
                ...
                @if ($wineries->isNotEmpty())
                    <div class="mt-6">
                        <x-label for="winery_id">Bodega <span
                                class="text-gray-500 font-normal">(opcional)</span></x-label>
                        <x-select wire:model="winery_id" id="winery_id" :error="$errors->first('winery_id')">
            ...
            <div class="bg-green-50 border-l-4 border-green-600 p-4 rounded-lg">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-green-800 mb-1">Nota importante:</p>
            ...
            <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
                <x-button href="{{ route('viticulturist.personal.index', ['viewMode' => 'personal']) }}"
                    variant="secondary">Cancelar</x-button>
