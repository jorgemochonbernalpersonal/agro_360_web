<div class="space-y-6 animate-fade-in">
    ...
    <x-agro.page-header
        ...
        :description="__('Crea un nuevo viticultor para gestionar en tus cuadrillas y parcelas')"
    >
        <x-slot:actions>
    ...
    <x-agro.card>
        <form wire:submit="save" class="space-y-8">
            ...
            <x-agro.form-section :title="__('Información del Viticultor')">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <flux:field>
                        ...
                        <flux:input wire:model="name" type="text" id="name" :placeholder="__('Ej: Juan Pérez')"
                            required />
                ...
                @if ($wineries->isNotEmpty())
                    <div class="mt-6">
                        <flux:field>
                            <flux:label for="winery_id">{{ __('Bodega') }} <span
                                    class="text-zinc-500 font-normal">({{ __('opcional') }})</span></flux:label>
            ...
            <flux:callout variant="info">
                <flux:callout.heading>{{ __('Nota importante') }}:</flux:callout.heading>
                <flux:callout.text>
            ...
            <x-agro.form-actions
                ...
                :submit-label="__('Crear Viticultor')"
            />
        </form>
    </x-agro.card>
</div>
