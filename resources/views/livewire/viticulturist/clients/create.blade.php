    ...
    >
        <form wire:submit="save" class="space-y-8" data-cy="client-create-form">
                        ...
                        <div class="border-2 border-gray-200 rounded-lg p-4 bg-white shadow-sm hover:border-blue-300 transition-colors" data-cy="address-item" data-cy-address-index="{{ $index }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-select wire:model.live="addresses.{{ $index }}.autonomous_community_id" id="addresses_{{ $index }}_autonomous_community_id" data-cy="address-autonomous-community" data-cy-address-index="{{ $index }}">
                                ...
                                <div>
                                    ...
                                    <x-select wire:model.live="addresses.{{ $index }}.province_id" id="addresses_{{ $index }}_province_id" data-cy="address-province" data-cy-address-index="{{ $index }}">
                                        <option value="">Seleccionar...</option>
                                ...
                                <div>
                                    ...
                                    <x-select wire:model.live="addresses.{{ $index }}.municipality_id" id="addresses_{{ $index }}_municipality_id" data-cy="address-municipality" data-cy-address-index="{{ $index }}">
                                        <option value="">Seleccionar...</option>
            ...
            <div class="flex justify-end gap-4">
                <x-button type="button" variant="ghost" href="{{ route('viticulturist.clients.index') }}" data-cy="cancel-button">Cancelar</x-button>
                <x-button type="submit" variant="primary" data-cy="submit-button">Crear Cliente</x-button>
            </div>
        </form>
    </x-form-card>
</div>
