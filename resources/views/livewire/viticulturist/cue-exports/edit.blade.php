<x-agro.form-card
    :title="__('Editar Exportación CUE')"
    :description="__('Exportación') . ' ' . $cueExport->campaign_year . ' — ' . $cueExport->exploitation->exploitation_name"
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-actions
            ...
            :submit-label="__('Actualizar Exportación')"
        />
    </form>
</x-agro.form-card>
