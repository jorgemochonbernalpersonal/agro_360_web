<div class="space-y-6 animate-fade-in">
    ...
    <x-agro.modal name="subcontracting-filters" maxWidth="sm">
        ...
        <div class="px-6 py-5 space-y-5">
            ...
            <div>
                <label class="block text-xs font-semibold text-zinc-500 uppercase tracking-wide mb-1.5">{{ __('Tipo de servicio') }}</label>
            ...
            <div>
                <label class="block text-xs font-semibold text-zinc-500 uppercase tracking-wide mb-1.5">{{ __('Facturación') }}</label>
