<x-agro.form-card
    :title="__('Editar Entorno de Parcela')"
    :description="__('Modifica la ficha de entorno de') . ' ' . ($plotEnvironment->plot->name ?? __('parcela'))"
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-actions
            ...
            :submit-label="__('Actualizar Entorno')"
        />
    </form>
</x-agro.form-card>
