<x-agro.form-card
    :title="__('Nueva Autorización Comercial')"
    :description="__('Registra una autorización comercial de la explotación')"
...
>
    <form wire:submit="save" class="space-y-8">
        <x-agro.form-section :title="__('Datos de la Autorización')">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <flux:field>
                    ...
                    <flux:input wire:model="issuing_body" type="text" :placeholder="__('Ej: Consejo Regulador DO Ribera del Duero')" />
                ...
                <flux:field>
                    ...
                    <flux:input wire:model="document_file" type="text" :placeholder="__('Ruta o referencia del documento')" />
        ...
        <x-agro.form-actions
            ...
            :submit-label="__('Registrar Autorización')"
        />
    </form>
</x-agro.form-card>
