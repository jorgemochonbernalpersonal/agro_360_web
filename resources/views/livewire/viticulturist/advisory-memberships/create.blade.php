<x-agro.form-card
    :title="__('Nuevo Asesor Técnico')"
    :description="__('Registra un asesor técnico de la explotación')"
...
>
    <form wire:submit="save" class="space-y-8">
        <x-agro.form-section :title="__('Datos del Asesor')">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <flux:field>
                    ...
                    <flux:input wire:model="advisor_name" type="text" :placeholder="__('Nombre completo')" />
                ...
                <flux:field>
                    ...
                    <flux:input wire:model="company_name" type="text" :placeholder="__('Nombre de la empresa')" />
        ...
        <x-agro.form-actions
            ...
            :submit-label="__('Registrar Asesor')"
        />
    </form>
</x-agro.form-card>
