        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Configuración de numeración de facturas</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <label class="flex items-center gap-3 p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50">
                        ...
                        >
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-900">Resetear cada año</p>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Configuración de numeración de albaranes</p>
                </div>
            </div>
