<div>
<x-agro.form-card
    :title="__('Añadir Póliza de Seguro')"
    :description="__('Registra una nueva póliza de seguro agrario para tu explotación.')"
...
>
    <form wire:submit.prevent="save" class="space-y-8">
        <x-agro.form-section :title="__('Datos de la Póliza')">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <flux:field>
                    ...
                    <flux:description>{{ __('Importe subsidiado por el Estado') }}</flux:description>
        ...
        <x-agro.form-actions :cancel-url="roleRoute('viticulturist.agri-insurance.index')" :submit-label="__('Guardar Póliza')" />
    </form>
</x-agro.form-card>
</div>
