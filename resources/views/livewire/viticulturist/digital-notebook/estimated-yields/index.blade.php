                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="bg-white rounded-xl p-6 border border-zinc-200">
                            <h3 class="text-lg font-bold text-zinc-900 mb-4">?? Distribución por Estado</h3>
                            <div class="space-y-4">
                                @php
                        ...
                        <div class="bg-white rounded-xl p-6 border border-zinc-200">
                            <h3 class="text-lg font-bold text-zinc-900 mb-4">?? Distribución por Método</h3>
                            <div class="space-y-4">
                                @php
                                ...
                                @empty
                                    <p class="text-zinc-500 text-center py-4">No hay datos de métodos</p>
                                @endforelse
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 border border-zinc-200">
                        ...
                        @if(($advancedStats['totalEstimated'] ?? 0) > 0)
                            ...
                            @endphp
                            <div class="mt-4">
                                <p class="text-sm text-zinc-600 mb-2">Precisión</p>
                                <div class="w-full bg-zinc-200 rounded-full h-3">
                    ...
                    <div class="bg-white rounded-xl p-6 border border-zinc-200">
                        <h3 class="text-lg font-bold text-zinc-900 mb-4">?? Estimaciones por Mes (Últimos 12 meses)</h3>
                    ...
                    <div class="bg-white rounded-xl p-6 border border-zinc-200">
                        <h3 class="text-lg font-bold text-zinc-900 mb-4">?? Distribución por Campaña ({{ $yearFilter }})</h3>
                        <div class="space-y-4">
                            ...
                            @empty
                                <p class="text-zinc-500 text-center py-4">No hay datos de campañas</p>
                            @endforelse
                        </div>
                    </div>
                </div>
