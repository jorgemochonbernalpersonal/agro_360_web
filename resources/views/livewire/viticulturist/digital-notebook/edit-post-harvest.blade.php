<x-agro.form-card
    :title="__('Editar Tratamiento Post-Vendimia')"
    :description="__('Modifica los datos del tratamiento post-vendimia')"
        ...
        <x-agro.form-section :title="__('Datos del Tratamiento')">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <flux:field>
                    ...
                    <flux:input wire:model="treated_area_ha" type="number" step="0.001" min="0.001" data-cy="treated-area-input" />
                    <flux:description>ha</flux:description>
                    <flux:error name="treated_area_ha" />
                </flux:field>
                <flux:field>
                    <flux:label>{{ __('Volumen de Caldo') }}</flux:label>
                    <flux:input wire:model="water_volume_liters" type="number" step="0.1" min="0" data-cy="water-volume-input" />
                    <flux:description>L</flux:description>
                </flux:field>
                <flux:field>
                    <flux:label>{{ __('Dosis / ha') }}</flux:label>
                    <flux:input wire:model="dose_per_hectare" type="number" step="0.001" min="0" data-cy="dose-per-hectare-input" />
                </flux:field>
                <flux:field>
