<x-agro.form-card
    :title="__('Registrar Poda')"
    :description="__('Registra una operación de poda en el cuaderno digital')"
...
>
    <form wire:submit="save" class="space-y-8">
        ...
        <x-agro.form-section :title="__('Datos de la Poda')">
            ...
            <div class="mt-6">
                <flux:field>
                    ...
                    <flux:textarea wire:model="description" data-cy="description-textarea" rows="4" :placeholder="__('Descripción detallada de la poda realizada...')" />
        ...
        <x-agro.form-actions
            ...
            :submit-label="__('Registrar Poda')"
        />
    </form>
</x-agro.form-card>
