<x-agro.form-card
    :title="__('Nueva Cuadrilla')"
    :description="__('Crea un nuevo equipo de trabajo')"
...
>
    <form wire:submit="save" class="space-y-8" data-cy="crew-form">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <flux:field>
                        ...
                        <flux:input
                            ...
                            :placeholder="__('Ej: Cuadrilla Norte')"
                            required
                        />
                ...
                <div class="mt-6">
                    <flux:field>
                        ...
                        <flux:textarea
                            ...
                            rows="4"
                            :placeholder="__('Describe el propósito o función de esta cuadrilla...')"
                        />
        ...
        <x-agro.form-actions
            ...
            :submit-label="__('Crear Cuadrilla')"
        />
    </form>
</x-agro.form-card>
