<div>
    <x-form-card
        ...
        :back-url="route('viticulturist.invoices.show', $invoice->id)"
    >
        <form wire:submit="update" class="space-y-8">
            ...
            <x-form-section title="Códigos" color="blue">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                    ...
                    @if($invoice->status !== 'draft' || $invoice_number)
                        <div>
                            <x-label for="invoice_number">Código de Factura</x-label>
                            <x-input 
                            ...
                            @enderror
                            <p class="mt-2 text-xs text-gray-500">
                                💡 Código secuencial generado automáticamente al facturar. Puedes modificarlo si lo necesitas.
                                @if($invoice_number_modified)
                                    <span class="text-orange-600 font-semibold">⚠️ Has modificado el código automático.</span>
                                @endif
                            </p>
                        </div>
            ...
            <x-form-section title="Estados" color="orange">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <x-select wire:model="delivery_status" id="delivery_status" required>
            ...
            <div class="flex justify-end gap-4">
                <x-button type="button" variant="ghost" href="{{ route('viticulturist.invoices.show', $invoice->id) }}">Cancelar</x-button>
