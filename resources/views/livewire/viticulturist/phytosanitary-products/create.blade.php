<x-agro.form-card
    :title="__('Nuevo Producto Fitosanitario')"
    :description="__('Añade un producto para poder seleccionarlo al registrar tratamientos')"
...
>
    <form wire:submit="save" class="space-y-8" data-cy="product-form">
        ...
        <x-agro.form-actions
            ...
            :submit-label="__('Crear Producto')"
        />
    </form>
</x-agro.form-card>
