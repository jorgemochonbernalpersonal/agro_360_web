<div class="space-y-6 animate-fade-in">
    ...
    <!-- Header -->
    <x-agro.page-header
        :title="__('Nueva Campaña')"
        :description="__('Crea una nueva campaña vitícola')"
    >
        <x-slot:actions>
    ...
    <x-agro.card data-cy="campaign-create-form">
        <form wire:submit="save" class="space-y-8" data-cy="campaign-form">
            ...
            <x-agro.form-section :title="__('Opciones')">
                <div class="flex items-center">
                    <flux:checkbox
                        ...
                        :label="__('Activar esta campaña automáticamente')"
                    />
                </div>
            ...
            <!-- Botones -->
            <x-agro.form-actions :cancelUrl="roleRoute('viticulturist.campaign.index')" :submitLabel="__('Crear Campaña')" />
        </form>
    </x-agro.card>
</div>
