        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12">
                ...
                <p class="text-xl text-gray-600 leading-relaxed">
                    Gestiona tus viñedos en la <strong>DOCa Penedès</strong> con Agro365. Cuaderno de campo digital, control PAC y cumplimiento del Consejo Regulador. Más de <strong>26.000 hectáreas</strong> de viñedo en la primera Denominación de Origen Calificada de España.
                </p>
            </div>
            ...
            <article class="prose prose-lg max-w-none">
                ...
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">La DOCa Penedès: Primera Denominación Calificada de España</h2>
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <ul class="text-sm text-gray-700 ml-4 mt-1">
                                        <li>• Xarel·lo, Macabeo, Parellada (60%) - Variedad principal</li>
                                        <li>• Garnacha (12%)</li>
                ...
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">Desafíos de los Viticultores en Penedès</h2>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">
                                        Las heladas de abril-mayo son el mayor riesgo en Penedès Alavesa y Alta. Pueden destruir brotes recién formados y reducir la cosecha hasta un 80%.
                                    </p>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">
                                        Tormentas de granizo en julio-agosto pueden dañar racimos y hojas. Penedès Oriental es especialmente vulnerable.
                                    </p>
                                    <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                        <p class="font-semibold text-green-800 mb-2">✅ Solución con Agro365:</p>
                                        <ul class="text-sm text-gray-700 space-y-1">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">
                                        El Consejo Regulador de Penedès exige rendimientos máximos estrictos: <strong>12.000 kg/ha para crianza</strong> y <strong>9.000 kg/ha para joven</strong>. Superar estos límites descalifica la cosecha.
                                    </p>
                                    <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                        <p class="font-semibold text-green-800 mb-2">✅ Solución con Agro365:</p>
                                        <ul class="text-sm text-gray-700 space-y-1">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">
                                        Primaveras húmedas favorecen el mildiu. El oidio es persistente en Penedès Alta. Ambos requieren tratamientos preventivos precisos.
                                    </p>
                                    <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                        <p class="font-semibold text-green-800 mb-2">✅ Solución con Agro365:</p>
                                        <ul class="text-sm text-gray-700 space-y-1">
                ...
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">Funcionalidades Clave para Viticultores de Penedès</h2>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-white p-6 rounded-xl border border-green-200">
                            ...
                            <h3 class="font-bold text-lg text-[var(--color-agro-green-dark)] mb-2">Gestión SIGPAC Penedès</h3>
                            <p class="text-gray-700 text-sm">
                                Importa tus parcelas SIGPAC de La Penedès, Álava y Navarra. Visualiza en mapa, calcula superficies exactas y mantén actualizado el registro.
                            </p>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-white p-6 rounded-xl border border-green-200">
                            ...
                            <p class="text-gray-700 text-sm">
                                Aunque Penedès es mayormente secano, registra riegos de apoyo en parcelas autorizadas. Control de concesiones y volúmenes aplicados.
                            </p>
                        </div>
                ...
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">Normativa del Consejo Regulador de Penedès</h2>
                    ...
                    <div class="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-lg mb-6">
                            ...
                            <table class="min-w-full text-sm">
                                ...
                                <tbody class="text-gray-700">
                                    ...
                                    <tr class="border-t border-red-200 bg-red-50">
                                        ...
                                        <td class="px-4 py-2 font-semibold">12.000 kg/ha</td>
                        ...
                        <p class="text-sm text-red-700 mt-4">
                            ⚠️ <strong>Importante:</strong> Superar estos rendimientos descalifica la uva para la DO Penedès. Agro365 calcula automáticamente el rendimiento de cada parcela.
                        </p>
                    </div>
                ...
                <section class="mb-12">
                    <div class="bg-gradient-to-r from-[var(--color-agro-green-bg)] to-[var(--color-agro-green-light)]/30 p-8 rounded-xl border border-[var(--color-agro-green)]/20">
                        <h3 class="text-2xl font-bold text-[var(--color-agro-green-dark)] mb-4">🍷 Gestiona tu Viñedo en Penedès con Agro365</h3>
                        <p class="text-gray-700 mb-6">
                            Únete a cientos de viticultores de Penedès que ya usan Agro365. Cuaderno de campo digital, control de rendimientos, cumplimiento del Consejo Regulador y <strong>3 meses gratis</strong> para probar.
                        </p>
