    ...
    <div class="min-h-screen bg-gradient-to-b from-white to-gray-50 py-20">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="text-sm text-gray-500 mb-6">
                ...
                <span class="text-gray-700">{{ __('Priorat') }}</span>
            </nav>
            ...
            <div class="mb-12">
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-100 border border-red-300 mb-6">
                    ...
                    <span class="text-sm font-semibold text-red-800">{{ __('DOQ Priorat - Denominación de Origen Calificada') }}</span>
                </div>
                <h1 class="text-5xl lg:text-6xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('Software para Viticultores en Priorat') }}</h1>
                <p class="text-xl text-gray-600 leading-relaxed">
                    Gestiona tus viñedos en la <strong>{{ __('DOCa Priorat') }}</strong> con Agro365. Cuaderno de campo digital, control PAC y cumplimiento del Consejo Regulador. Más de <strong>{{ __('1.900 hectáreas') }}</strong> de viñedo en la primera Denominación de Origen Calificada de España.
                </p>
            </div>
            ...
            <article class="prose prose-lg max-w-none">
                ...
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('La DOCa Priorat: Primera Denominación Calificada de España') }}</h2>
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-8">
                        <div class="bg-gradient-to-br from-red-50 to-white p-6 rounded-xl border border-red-200">
                            ...
                            <ul class="space-y-2 text-gray-700">
                                <li><strong>{{ __('Superficie:') }}</strong> 1.900 hectáreas</li>
                                <li><strong>{{ __('Bodegas:') }}</strong> 100+ bodegas registradas</li>
                                <li><strong>{{ __('Viticultores:') }}</strong> 600+ viticultores</li>
                                <li><strong>{{ __('Producción anual:') }}</strong> 5 millones de litros</li>
                                <li><strong>{{ __('Zonas:') }}</strong> Gratallops, Porrera, Poboleda, Torroja, La Morera, La Vilella, Bellmunt, El Lloar, Scala Dei, Masos de Falset, Solanes del Molar</li>
                            </ul>
                        </div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <ul class="text-sm text-gray-700 ml-4 mt-1">
                                        <li>{{ __('• Garnacha y Cariñena (70%) - Variedad principal') }}</li>
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg mb-6">
                        <p class="text-gray-800">
                            <strong>{{ __('Mediterráneo con influencia continental:') }}</strong>  Veranos muy cálidos y secos, inviernos suaves. Precipitación 400-500mm anuales. Altitud 100-700m.</p>
                    </div>
                </section>

                <!-- Desafíos Específicos de Priorat -->
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('Desafíos de los Viticultores en Priorat') }}</h2>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">{{ __('Las heladas de abril-mayo son el mayor riesgo en Priorat Alavesa y Alta. Pueden destruir brotes recién formados y reducir la cosecha hasta un 80%.') }}</p>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">{{ __('Tormentas de granizo en julio-agosto pueden dañar racimos y hojas. Priorat Oriental es especialmente vulnerable.') }}</p>
                                    <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                        <p class="font-semibold text-green-800 mb-2">{{ __('✅ Solución con Agro365:') }}</p>
                                        <ul class="text-sm text-gray-700 space-y-1">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">
                                        El Consejo Regulador de Priorat exige rendimientos máximos estrictos: <strong>{{ __('6.000 kg/ha para crianza') }}</strong> y <strong>{{ __('9.000 kg/ha para joven') }}</strong>. Superar estos límites descalifica la cosecha.
                                    </p>
                                    <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                        <p class="font-semibold text-green-800 mb-2">{{ __('✅ Solución con Agro365:') }}</p>
                                        <ul class="text-sm text-gray-700 space-y-1">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">{{ __('Primaveras húmedas favorecen el mildiu. El oidio es persistente en Priorat Alta. Ambos requieren tratamientos preventivos precisos.') }}</p>
                                    <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                        <p class="font-semibold text-green-800 mb-2">{{ __('✅ Solución con Agro365:') }}</p>
                                        <ul class="text-sm text-gray-700 space-y-1">
                ...
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('Funcionalidades Clave para Viticultores de Priorat') }}</h2>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-white p-6 rounded-xl border border-green-200">
                            ...
                            <h3 class="font-bold text-lg text-[var(--color-agro-green-dark)] mb-2">{{ __('Gestión SIGPAC Priorat') }}</h3>
                            <p class="text-gray-700 text-sm">{{ __('Importa tus parcelas SIGPAC de La Priorat, Álava y Navarra. Visualiza en mapa, calcula superficies exactas y mantén actualizado el registro.') }}</p>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-white p-6 rounded-xl border border-green-200">
                            ...
                            <p class="text-gray-700 text-sm">{{ __('Aunque Priorat es mayormente secano, registra riegos de apoyo en parcelas autorizadas. Control de concesiones y volúmenes aplicados.') }}</p>
                        </div>
                ...
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('Normativa del Consejo Regulador de Priorat') }}</h2>
                    ...
                    <div class="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-lg mb-6">
                            ...
                            <table class="min-w-full text-sm">
                                ...
                                <tbody class="text-gray-700">
                                    ...
                                    <tr class="border-t border-red-200 bg-red-50">
                                        ...
                                        <td class="px-4 py-2 font-semibold">{{ __('6.000 kg/ha') }}</td>
                        ...
                        <p class="text-sm text-red-700 mt-4">
                            ⚠️ <strong>{{ __('Importante:') }}</strong> Superar estos rendimientos descalifica la uva para la DO Priorat. Agro365 calcula automáticamente el rendimiento de cada parcela.
                        </p>
                    </div>
                ...
                <section class="mb-12">
                    <div class="bg-gradient-to-r from-[var(--color-agro-green-bg)] to-[var(--color-agro-green-light)]/30 p-8 rounded-xl border border-[var(--color-agro-green)]/20">
                        <h3 class="text-2xl font-bold text-[var(--color-agro-green-dark)] mb-4">{{ __('🍷 Gestiona tu Viñedo en Priorat con Agro365') }}</h3>
                        <p class="text-gray-700 mb-6">
                            Únete a cientos de viticultores de Priorat que ya usan Agro365. Cuaderno de campo digital, control de rendimientos, cumplimiento del Consejo Regulador y <strong>{{ __('3 meses gratis') }}</strong> para probar.
                        </p>
