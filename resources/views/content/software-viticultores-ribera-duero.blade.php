    ...
    <div class="min-h-screen bg-gradient-to-b from-white to-gray-50 py-20">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="text-sm text-gray-500 mb-6">
                ...
                <span class="text-gray-700">{{ __('Ribera del Duero') }}</span>
            </nav>
            ...
            <div class="mb-12">
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-100 border border-red-300 mb-6">
                    ...
                    <span class="text-sm font-semibold text-red-800">{{ __('DO Ribera del Duero') }}</span>
                </div>
                <h1 class="text-5xl lg:text-6xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('Software para Viticultores en Ribera del Duero') }}</h1>
                <p class="text-xl text-gray-600 leading-relaxed">
                    Gestiona tus viñedos en la <strong>{{ __('DOCa Ribera del Duero') }}</strong> con Agro365. Cuaderno de campo digital, control PAC y cumplimiento del Consejo Regulador. Más de <strong>{{ __('23.000 hectáreas') }}</strong> de viñedo en la primera Denominación de Origen Calificada de España.
                </p>
            </div>
            ...
            <article class="prose prose-lg max-w-none">
                ...
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('La DO Ribera del Duero: Excelencia Vinícola en Castilla y León') }}</h2>
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-8">
                        <div class="bg-gradient-to-br from-red-50 to-white p-6 rounded-xl border border-red-200">
                            ...
                            <ul class="space-y-2 text-gray-700">
                                <li><strong>{{ __('Superficie:') }}</strong> 23.000 hectáreas</li>
                                <li><strong>{{ __('Bodegas:') }}</strong> 300+ bodegas registradas</li>
                                <li><strong>{{ __('Viticultores:') }}</strong> 8.000+ viticultores</li>
                                <li><strong>{{ __('Producción anual:') }}</strong> 100 millones de litros</li>
                                <li><strong>{{ __('Provincias:') }}</strong> Burgos, Valladolid, Segovia y Soria</li>
                                <li><strong>{{ __('Longitud:') }}</strong> 115 km a lo largo del río Duero</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-white p-6 rounded-xl border border-green-200">
                            ...
                            <div class="space-y-3">
                                <div>
                                    <p class="font-semibold text-gray-800">{{ __('Tintas (principales):') }}</p>
                                    <ul class="text-sm text-gray-700 ml-4 mt-1">
                                        <li>{{ __('• Tinta del País (Tempranillo) - Variedad principal (mín. 75%)') }}</li>
                                        <li>{{ __('• Cabernet Sauvignon, Merlot, Malbec (máx. 25%)') }}</li>
                                        <li>{{ __('• Garnacha Tinta, Albillo Mayor') }}</li>
                                    </ul>
                                </div>
                                <div>
                                    <p class="font-semibold text-gray-800">{{ __('Blancas (minoritarias):') }}</p>
                                    <ul class="text-sm text-gray-700 ml-4 mt-1">
                                        <li>{{ __('• Albillo Mayor - Variedad autóctona') }}</li>
                                        <li>{{ __('• Vinos blancos desde 2019') }}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg mb-6">
                        <p class="text-gray-800">
                            <strong>{{ __('Clima Continental Extremo:') }}</strong> Inviernos muy fríos (hasta -18°C) con riesgo de heladas, veranos cálidos y secos (hasta 40°C). Precipitación media de 400-600mm anuales. Gran amplitud térmica día-noche que favorece la maduración y concentración aromática.
                        </p>
                    </div>
                </section>

                <!-- Desafíos Específicos de Ribera del Duero -->
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('Desafíos de los Viticultores en Ribera del Duero') }}</h2>
                    ...
                    <div class="space-y-6">
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">{{ __('Las heladas de abril-mayo son el mayor riesgo en toda la Ribera del Duero. El clima continental extremo puede provocar heladas hasta -5°C que destruyen brotes recién formados y reducen la cosecha hasta un 80%.') }}</p>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            <div class="flex items-start gap-4">
                                <div class="text-4xl">🌧️</div>
                                <div class="flex-1">
                                    <h3 class="font-bold text-xl text-gray-900 mb-2">{{ __('2. Granizo y Sequía Estival') }}</h3>
                                    <p class="text-gray-700 mb-3">{{ __('Tormentas de granizo en julio-agosto pueden dañar racimos. La sequía estival es común, con veranos muy secos que requieren gestión cuidadosa del estrés hídrico de la vid.') }}</p>
                                    <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                        <p class="font-semibold text-green-800 mb-2">{{ __('✅ Solución con Agro365:') }}</p>
                                        <ul class="text-sm text-gray-700 space-y-1">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">
                                        El Consejo Regulador de Ribera del Duero exige rendimientos máximos estrictos: <strong>{{ __('7.000 kg/ha para crianza') }}</strong> y <strong>{{ __('9.000 kg/ha para joven') }}</strong>. Superar estos límites descalifica la cosecha.
                                    </p>
                                    <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                        <p class="font-semibold text-green-800 mb-2">{{ __('✅ Solución con Agro365:') }}</p>
                                        <ul class="text-sm text-gray-700 space-y-1">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">{{ __('Primaveras húmedas favorecen el mildiu. El oidio es persistente en toda la región. Ambos requieren tratamientos preventivos precisos y registro obligatorio de fitosanitarios.') }}</p>
                                    <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                        <p class="font-semibold text-green-800 mb-2">{{ __('✅ Solución con Agro365:') }}</p>
                                        <ul class="text-sm text-gray-700 space-y-1">
                ...
                <!-- Funcionalidades Clave para Ribera del Duero -->
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('Funcionalidades Clave para Viticultores de Ribera del Duero') }}</h2>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-white p-6 rounded-xl border border-green-200">
                            ...
                            <h3 class="font-bold text-lg text-[var(--color-agro-green-dark)] mb-2">{{ __('Gestión SIGPAC Ribera del Duero') }}</h3>
                            <p class="text-gray-700 text-sm">{{ __('Importa tus parcelas SIGPAC de Burgos, Valladolid, Segovia y Soria. Visualiza en mapa, calcula superficies exactas y mantén actualizado el registro para PAC y Consejo Regulador.') }}</p>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-white p-6 rounded-xl border border-green-200">
                            ...
                            <p class="text-gray-700 text-sm">{{ __('Aunque Ribera del Duero es mayormente secano, registra riegos de apoyo en parcelas autorizadas. Control de concesiones y volúmenes aplicados.') }}</p>
                        </div>
                ...
                <!-- Normativa Específica de Ribera del Duero -->
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('Normativa del Consejo Regulador de Ribera del Duero') }}</h2>
                    ...
                    <div class="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-lg mb-6">
                        ...
                        <p class="text-sm text-red-700 mt-4">
                            ⚠️ <strong>{{ __('Importante:') }}</strong> Superar estos rendimientos descalifica la uva para la DO Ribera del Duero. Agro365 calcula automáticamente el rendimiento de cada parcela.
                        </p>
                    </div>
                ...
                <section class="mb-12">
                    <div class="bg-gradient-to-r from-[var(--color-agro-green-bg)] to-[var(--color-agro-green-light)]/30 p-8 rounded-xl border border-[var(--color-agro-green)]/20">
                        <h3 class="text-2xl font-bold text-[var(--color-agro-green-dark)] mb-4">{{ __('🍷 Gestiona tu Viñedo en Ribera del Duero con Agro365') }}</h3>
                        <p class="text-gray-700 mb-6">
                            Únete a cientos de viticultores de Ribera del Duero que ya usan Agro365. Cuaderno de campo digital, control de rendimientos, cumplimiento del Consejo Regulador y <strong>{{ __('3 meses gratis') }}</strong> para probar.
                        </p>
