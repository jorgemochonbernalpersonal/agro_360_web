...
<head>
    ...
    <meta name="description" content="Software para viticultores de Rías Baixas. Cuaderno digital obligatorio 2027, teledetección NDVI y facturación Verifactu. Gestiona Albariño, Treixadura y Caiño. Rendimientos 10.000 kg/ha y cumplimiento Consejo Regulador.">
    ...
    <meta property="og:description" content="Gestión especializada para viñedos de Albariño en Rías Baixas. Cuaderno digital, teledetección NDVI, Verifactu y cumplimiento Consejo Regulador.">
    ...
    <div class="min-h-screen bg-gradient-to-b from-white to-gray-50 py-20">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="text-sm text-gray-500 mb-6">
                ...
                <span class="text-gray-700">{{ __('Rías Baixas') }}</span>
            </nav>
            ...
            <div class="mb-12">
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-100 border border-red-300 mb-6">
                    ...
                    <span class="text-sm font-semibold text-red-800">{{ __('DO Rías Baixas') }}</span>
                </div>
                <h1 class="text-5xl lg:text-6xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('Software para Viticultores en Rías Baixas') }}</h1>
                <p class="text-xl text-gray-600 leading-relaxed">
                    Gestiona tus viñedos en la <strong>{{ __('DOCa Rías Baixas') }}</strong> con Agro365. Cuaderno de campo digital, control PAC y cumplimiento del Consejo Regulador. Más de <strong>{{ __('4.000 hectáreas') }}</strong> de viñedo en la primera Denominación de Origen Calificada de España.
                </p>
            </div>

            <!-- Content -->
            <article class="prose prose-lg max-w-none">
                <!-- Características de la DOCa Rías Baixas -->
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('La DOCa Rías Baixas: Primera Denominación Calificada de España') }}</h2>
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-8">
                        <div class="bg-gradient-to-br from-red-50 to-white p-6 rounded-xl border border-red-200">
                            ...
                            <ul class="space-y-2 text-gray-700">
                                <li><strong>{{ __('Superficie:') }}</strong> 4.000 hectáreas</li>
                                <li><strong>{{ __('Bodegas:') }}</strong> 180+ bodegas registradas</li>
                                <li><strong>{{ __('Viticultores:') }}</strong> 5.500+ viticultores</li>
                                <li><strong>{{ __('Producción anual:') }}</strong> 35 millones de litros</li>
                                <li><strong>{{ __('Zonas:') }}</strong> Val do Salnés, Condado do Tea, O Rosal, Soutomaior, Ribeira do Ulla</li>
                            </ul>
                        </div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <ul class="text-sm text-gray-700 ml-4 mt-1">
                                        <li>{{ __('• Albariño (96%) - Variedad principal') }}</li>
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg mb-6">
                        <p class="text-gray-800">
                            <strong>{{ __('Atlántico húmedo:') }}</strong>  Lluvias abundantes (1.200-1.600mm anuales). Temperaturas suaves. Alta humedad relativa. Influencia oceánica directa.</p>
                    </div>
                </section>

                <!-- Desafíos Específicos de Rías Baixas -->
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('Desafíos de los Viticultores en Rías Baixas') }}</h2>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">{{ __('Las heladas de abril-mayo son el mayor riesgo en Rías Baixas Alavesa y Alta. Pueden destruir brotes recién formados y reducir la cosecha hasta un 80%.') }}</p>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">{{ __('Tormentas de granizo en julio-agosto pueden dañar racimos y hojas. Rías Baixas Oriental es especialmente vulnerable.') }}</p>
                                    <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                        <p class="font-semibold text-green-800 mb-2">{{ __('✅ Solución con Agro365:') }}</p>
                                        <ul class="text-sm text-gray-700 space-y-1">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">
                                        El Consejo Regulador de Rías Baixas exige rendimientos máximos estrictos: <strong>{{ __('10.000 kg/ha para crianza') }}</strong> y <strong>{{ __('9.000 kg/ha para joven') }}</strong>. Superar estos límites descalifica la cosecha.
                                    </p>
                                    <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                        <p class="font-semibold text-green-800 mb-2">{{ __('✅ Solución con Agro365:') }}</p>
                                        <ul class="text-sm text-gray-700 space-y-1">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mb-3">{{ __('Primaveras húmedas favorecen el mildiu. El oidio es persistente en Rías Baixas Alta. Ambos requieren tratamientos preventivos precisos.') }}</p>
                                    <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                        <p class="font-semibold text-green-800 mb-2">{{ __('✅ Solución con Agro365:') }}</p>
                                        <ul class="text-sm text-gray-700 space-y-1">
                ...
                <!-- Funcionalidades Clave para Rías Baixas -->
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('Funcionalidades Clave para Viticultores de Rías Baixas') }}</h2>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-white p-6 rounded-xl border border-green-200">
                            ...
                            <h3 class="font-bold text-lg text-[var(--color-agro-green-dark)] mb-2">{{ __('Gestión SIGPAC Rías Baixas') }}</h3>
                            <p class="text-gray-700 text-sm">{{ __('Importa tus parcelas SIGPAC de La Rías Baixas, Álava y Navarra. Visualiza en mapa, calcula superficies exactas y mantén actualizado el registro.') }}</p>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-white p-6 rounded-xl border border-green-200">
                            ...
                            <p class="text-gray-700 text-sm">{{ __('Aunque Rías Baixas es mayormente secano, registra riegos de apoyo en parcelas autorizadas. Control de concesiones y volúmenes aplicados.') }}</p>
                        </div>
                ...
                <!-- Normativa Específica de Rías Baixas -->
                <section class="mb-12">
                    <h2 class="text-3xl font-bold text-[var(--color-agro-green-dark)] mb-6">{{ __('Normativa del Consejo Regulador de Rías Baixas') }}</h2>
                    ...
                    <div class="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-lg mb-6">
                        ...
                        <p class="text-sm text-red-700 mt-4">
                            ⚠️ <strong>{{ __('Importante:') }}</strong> Superar estos rendimientos descalifica la uva para la DO Rías Baixas. Agro365 calcula automáticamente el rendimiento de cada parcela.
                        </p>
                    </div>
                ...
                <section class="mb-12">
                    <div class="bg-gradient-to-r from-[var(--color-agro-green-bg)] to-[var(--color-agro-green-light)]/30 p-8 rounded-xl border border-[var(--color-agro-green)]/20">
                        <h3 class="text-2xl font-bold text-[var(--color-agro-green-dark)] mb-4">{{ __('🍷 Gestiona tu Viñedo en Rías Baixas con Agro365') }}</h3>
                        <p class="text-gray-700 mb-6">
                            Únete a cientos de viticultores de Rías Baixas que ya usan Agro365. Cuaderno de campo digital, control de rendimientos, cumplimiento del Consejo Regulador y <strong>{{ __('3 meses gratis') }}</strong> para probar.
                        </p>
