                ...
                <section class="mb-12">
                    <div class="bg-gradient-to-r from-[var(--color-agro-green-bg)] to-[var(--color-agro-green-light)]/30 p-8 rounded-xl border border-[var(--color-agro-green)]/20">
                        ...
                        <p class="text-gray-700 mb-6">
                            Únete a cientos de viticultores de Rías Baixas que ya usan Agro365. Cuaderno de campo digital, control de rendimientos, cumplimiento del Consejo Regulador y <strong>6 meses gratis</strong> para probar.
                        </p>
