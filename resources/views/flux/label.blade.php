...
@php
    $classes = Flux::classes()
        ->add('inline-flex items-center gap-0.5')
...
<ui-label {{ $attributes->except('required')->class($classes) }} data-flux-label>
    {{ $slot }}

    @if ($required)
        <span class="text-red-500 text-sm leading-none" aria-hidden="true">*</span>
    @endif
