...
<x-app-layout>
    <div class="space-y-6 animate-fade-in">
        ...
        <x-page-header
            :icon="$profileIcon"
            title="{{ __('Mi Perfil') }}"
            :description="__('Vista general de tu información personal y configuración')"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                    <div class="bg-gradient-to-r from-gray-50 to-white border-b border-gray-200 px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-xl font-bold text-gray-900">{{ __('Información Personal') }}</h3>
                        </div>
                    </div>
                    <div class="p-6 space-y-4">
                        <div class="flex items-start gap-4">
                            ...
                            @if($profile && $profile->profile_image)
                                <img 
                                    ...
                                    loading="lazy"
                                    decoding="async"
                                    class="w-16 h-16 rounded-full object-cover border-4 border-gray-200 shadow-lg flex-shrink-0" 
                        ...
                        <div class="flex items-center gap-4 p-4 bg-green-50 rounded-lg border border-green-200">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-medium text-green-700">{{ __('Rol en el Sistema') }}</p>
                        ...
                        @if($profile)
                            <div class="pt-4 border-t border-gray-200">
                                <h4 class="text-sm font-bold text-gray-700 mb-3">{{ __('Información de Contacto') }}</h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    @if($profile->phone)
                                        <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <div>
                                                <p class="text-xs font-medium text-gray-500">{{ __('Teléfono') }}</p>
                                    ...
                                    @if($profile->city)
                                        <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <div>
                                                <p class="text-xs font-medium text-gray-500">{{ __('Ciudad') }}</p>
                                    ...
                                    @if($profile->province_id)
                                        <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <div>
                                                <p class="text-xs font-medium text-gray-500">{{ __('Provincia') }}</p>
                                    ...
                                    @if($profile->address)
                                        <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg md:col-span-2">
                                            ...
                                            <div>
                                                <p class="text-xs font-medium text-gray-500">{{ __('Dirección') }}</p>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                    <div class="bg-gradient-to-r from-gray-50 to-white border-b border-gray-200 px-6 py-4">
                        <h3 class="text-lg font-bold text-gray-900">{{ __('Acciones Rápidas') }}</h3>
                    </div>
                    <div class="p-4 space-y-2">
                        <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-blue-50 transition-all duration-200 group">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-semibold text-gray-900">{{ __('Editar Perfil') }}</p>
                                <p class="text-xs text-gray-500">{{ __('Actualiza tu información') }}</p>
                            </div>
                        ...
                        <a href="{{ route('subscription.manage') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-green-50 transition-all duration-200 group">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-semibold text-gray-900">{{ __('Suscripción') }}</p>
                                <p class="text-xs text-gray-500">{{ __('Gestiona tu plan') }}</p>
                            </div>
                            <svg class="w-5 h-5 text-gray-400 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                ...
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl shadow-lg border border-gray-200 p-6">
                    <h3 class="text-lg font-bold text-gray-900 mb-4">{{ __('Información de Cuenta') }}</h3>
                    <div class="space-y-3">
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-gray-600">{{ __('Estado de email') }}</span>
                            ...
                            @else
                                <span class="inline-flex items-center gap-1 px-2 py-1 bg-yellow-100 text-yellow-700 rounded-full text-xs font-semibold">{{ __('Pendiente') }}</span>
                            @endif
                        </div>
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-gray-600">{{ __('Miembro desde') }}</span>
