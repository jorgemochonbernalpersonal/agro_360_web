...
class DemoBulkFillSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->fillTo('cue_exports', 'viticulturist_id', function ($i) use ($expId, $now) {
            ...
            return [
                ...
                'payload_json' => null,
                'response_json' => null,
                'generated_at' => $statuses[$p] !== 'draft' ? sprintf('%d-%02d-05 09:00:00', $toM >= 12 ? 2027 : 2026, $toM >= 12 ? 1 : $toM + 1) : null,
                'sent_at' => $statuses[$p] !== 'draft' ? sprintf('%d-%02d-06 09:00:00', $toM >= 12 ? 2027 : 2026, $toM >= 12 ? 1 : $toM + 1) : null,
                'accepted_at' => $statuses[$p] === 'accepted' ? sprintf('%d-%02d-08 11:00:00', $toM >= 12 ? 2027 : 2026, $toM >= 12 ? 1 : $toM + 1) : null,
                'error_message' => null,
                'file_path' => null,
                'created_at' => $now, 'updated_at' => $now,
            ];
