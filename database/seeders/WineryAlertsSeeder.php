    ...
    public function run(): void
    {
        ...
        $rows = [
            [
                ...
                'read_at'        => null,
                'auto_generated' => true,
                'triggered_at'   => now()->subHours(2)->toIso8601String(),
            ...
            [
                ...
                'read_at'        => null,
                'auto_generated' => true,
                'triggered_at'   => now()->subDays(1)->toIso8601String(),
            ...
            [
                ...
                'read_at'        => null,
                'auto_generated' => true,
                'triggered_at'   => now()->subHours(6)->toIso8601String(),
                'expires_at'     => null,
                'created_at'     => $now,
                'updated_at'     => $now,
            ],
            [
                ...
                'read_at'        => null,
                'auto_generated' => true,
                'triggered_at'   => now()->subDays(5)->toIso8601String(),
                'expires_at'     => null,
                'created_at'     => $now,
                'updated_at'     => $now,
            ],
            [
                ...
                'reference_id'   => null,
                'is_read'        => true,
                'read_at'        => now()->subDays(1)->toIso8601String(),
                'auto_generated' => true,
                'triggered_at'   => now()->subDays(2)->toIso8601String(),
                'expires_at'     => null,
                'created_at'     => $now,
                'updated_at'     => $now,
            ],
            [
                ...
                'reference_id'   => null,
                'is_read'        => true,
                'read_at'        => now()->subDays(3)->toIso8601String(),
                'auto_generated' => false,
                'triggered_at'   => now()->subDays(4)->toIso8601String(),
                'expires_at'     => null,
                'created_at'     => $now,
                'updated_at'     => $now,
            ],
            [
                ...
                'read_at'        => null,
                'auto_generated' => false,
                'triggered_at'   => now()->subDays(7)->toIso8601String(),
