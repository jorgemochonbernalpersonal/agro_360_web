...
class PlotCatalogSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $valleys = [
            ['code' => 'RIO',  'name' => 'Rioja Alta',             'description' => 'Zona occidental de La Rioja. Suelos arcillo-calcáreos y clima atlántico-continental.'],
            ['code' => 'ROC',  'name' => 'Rioja Alavesa',          'description' => 'Vertiente sur de la Sierra Cantábrica. Terraza sobre el Ebro.'],
            ['code' => 'ROR',  'name' => 'Rioja Oriental',         'description' => 'Zona más cálida y árida de La Rioja. Predominan variedades Garnacha y Mazuelo.'],
            ['code' => 'RDD',  'name' => 'Ribera del Duero',       'description' => 'Altiplano sobre el río Duero. Temperaturas extremas y Tempranillo como variedad principal.'],
            ['code' => 'RGU',  'name' => 'Rías Baixas',            'description' => 'Zona atlántica gallega. Albariño sobre suelos graníticos.'],
            ['code' => 'PRI',  'name' => 'Priorat',                'description' => 'Suelos de pizarra (llicorella) en terraza. Garnacha y Cariñena.'],
            ['code' => 'PEN',  'name' => 'Penedès',                'description' => 'Tres altitudes diferenciadas. Base del Cava y variedades internacionales.'],
            ['code' => 'DUE',  'name' => 'Rueda',                  'description' => 'Meseta castellana sobre el Duero. Verdejo como variedad estrella.'],
            ['code' => 'TOK',  'name' => 'Toro',                   'description' => 'Meseta semiárida occidental. Tinta de Toro (Tempranillo) sobre suelos arenosos.'],
            ['code' => 'NAV',  'name' => 'Navarra',                'description' => 'Diversidad climática entre Pirineos y el Ebro. Garnacha y Tempranillo.'],
            ['code' => 'SOB',  'name' => 'Somontano',              'description' => 'Zona prepirenaica oscense. Variedades locales e internacionales.'],
            ['code' => 'JER',  'name' => 'Jerez-Xérès-Sherry',    'description' => 'Marco de Jerez sobre albarizas. Palomino Fino y sistema de criaderas.'],
            ['code' => 'MAN',  'name' => 'La Mancha',              'description' => 'Mayor región vitícola del mundo. Meseta castellana con clima continental extremo.'],
            ['code' => 'VAL',  'name' => 'Valencia',               'description' => 'Zonas de levante con influencia mediterránea.'],
            ['code' => 'JUM',  'name' => 'Jumilla',                'description' => 'Altiplano murciano. Monastrell sobre suelos calizos en secano.'],
            ['code' => 'YEC',  'name' => 'Yecla',                  'description' => 'Enclave montañoso murciano. Monastrell y Garnacha.'],
            ['code' => 'RIB',  'name' => 'Ribeiro',                'description' => 'Confluencia de ríos gallegos. Treixadura, Torrontés sobre suelos graníticos.'],
            ['code' => 'MON',  'name' => 'Monterrei',              'description' => 'Valle del Támega. Zona más cálida de Galicia.'],
            ['code' => 'BIE',  'name' => 'Bierzo',                 'description' => 'Valle protegido leonés. Mencía sobre pizarras y pizarras calizas.'],
            ['code' => 'TXA',  'name' => 'Txakoli de Getaria',     'description' => 'Costa vasca. Hondarrabi Zuri sobre suelos arcillosos.'],
            ['code' => 'MOR',  'name' => 'Moriles-Montilla',       'description' => 'Sur de Córdoba. Pedro Ximénez sobre suelos albarizos.'],
            ['code' => 'MEN',  'name' => 'Menorca',                'description' => 'Isla balear. Clima marítimo con merlot, cabernet y syrah.'],
            ['code' => 'MAL',  'name' => 'Mallorca (Binissalem)',   'description' => 'Interior mallorquín. Manto Negro y Callet como variedades autóctonas.'],
            ['code' => 'CAN',  'name' => 'Canarias (Tacoronte)',    'description' => 'Lavas volcánicas en Tenerife. Listán Negro y Listán Blanco.'],
        ];
