...
class WineryClientsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $clients = [
            ...
            ['client_type' => 'company', 'company_name' => 'Restaurante Mar de Nubes', 'company_document' => 'B98712340', 'first_name' => null, 'last_name' => null, 'email' => 'cocina@mardenubes.es', 'phone' => '+34 928 452 311', 'payment_method' => 'receipt', 'default_discount' => 0.00, 'has_cae' => false, 'active' => true, 'notes' => 'Restaurante en Puerto de Las Nieves. Especialidad en mariscos.'],
            ...
            ['client_type' => 'individual', 'company_name' => null, 'company_document' => null, 'first_name' => 'Carlos', 'last_name' => 'Navarro Suárez', 'email' => 'cnavarro@icloud.com', 'phone' => '+34 660 778 314', 'payment_method' => 'card', 'default_discount' => 5.00, 'has_cae' => false, 'active' => true, 'notes' => 'Sommelier freelance. Recomienda nuestros vinos en eventos de catas.'],
