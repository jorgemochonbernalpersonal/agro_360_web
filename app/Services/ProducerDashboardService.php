...
{
    /**
     * All aggregate stats shared between the API controller and the Livewire dashboard.
     *
     * @return array{field: array, winery: array, containers: array, alerts: array}
     */
