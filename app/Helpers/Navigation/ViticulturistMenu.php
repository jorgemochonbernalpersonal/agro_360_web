...
class ViticulturistMenu
{
    ...
    public static function resources(string $prefix, bool $includeContainers = false): array
    {
        ...
        return array_merge($items, [
            ['icon' => 'building-storefront', 'label' => 'Almacén de Insumos',       'route' => "{$prefix}.almacen.index",               'active' => request()->routeIs("{$prefix}.almacen.*") && !request()->routeIs("{$prefix}.almacen.stock.analytics") && !request()->routeIs("{$prefix}.almacen.stock.movements")],
            ['icon' => 'chart-bar-square',    'label' => 'Analítica de Stock',       'route' => "{$prefix}.almacen.stock.analytics",     'active' => request()->routeIs("{$prefix}.almacen.stock.analytics")],
