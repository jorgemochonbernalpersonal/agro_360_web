...
class SeoHelper
{
    ...
    public static function getMetaDescription(string $path, ?string $customDescription = null): string
    {
        ...
        $descriptions = [
            ...
            '/normativa-pac' => 'Normativa PAC: cambios, requisitos y cumplimiento. Cómo Agro365 te ayuda a cumplir con todas las normativas PAC automáticamente.',
            ...
            '/software-para-viticultores' => 'Software profesional para viticultores en España. Gestión completa de viñedos, cuaderno digital, SIGPAC, control de vendimia y cumplimiento normativo. Prueba gratis 6 meses.',
            ...
            '/cuaderno-digital-viticultores' => 'Cuaderno de campo digital para viticultores obligatorio desde 2027. Gestión de tratamientos, SIGPAC, cumplimiento normativo y informes oficiales. Prueba gratis 6 meses.',
