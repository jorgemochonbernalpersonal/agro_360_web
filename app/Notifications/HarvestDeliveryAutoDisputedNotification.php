...
class HarvestDeliveryAutoDisputedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject(__('Diferencia en entrega — :variety · :year', ['variety' => $variety, 'year' => $delivery->vintage_year]))
            ...
            ->line(__('Puedes revisar los datos y enviar una reclamación desde tu panel de vendimias si crees que hay un error.'))
