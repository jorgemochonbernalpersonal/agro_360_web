    ...
    public function render()
    {
        $query = Plot::forUser(Auth::user())
            ...
            ->with([
                ...
                'multiplePlotSigpacs.sigpacCode:id,code,code_autonomous_community,code_province,code_municipality,code_aggregate,code_zone,code_polygon,code_plot,code_enclosure',
