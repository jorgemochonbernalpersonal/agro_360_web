...
class FertilizationIndex extends AbstractActivityIndex
{
    ...
    {
        return __('Fertilizaciones');
    }

    protected function pageDescription(): string
    {
        return __('Registro de fertilizaciones aplicadas en tus parcelas');
    }

    protected function createRoute(): string
    {
        return roleRoute('digital-notebook.fertilization.create');
    }

    protected function editRouteSuffix(): string
    {
        return 'digital-notebook.fertilization.edit';
    }
