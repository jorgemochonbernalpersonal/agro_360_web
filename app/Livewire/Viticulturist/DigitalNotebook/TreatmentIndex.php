...
class TreatmentIndex extends AbstractActivityIndex
{
    ...
    {
        return __('Tratamientos Fitosanitarios');
    }

    protected function pageDescription(): string
    {
        return __('Registro de tratamientos fitosanitarios aplicados en tus parcelas');
    }

    protected function createRoute(): string
    {
        return roleRoute('digital-notebook.treatment.create');
    }

    protected function editRouteSuffix(): string
    {
        return 'digital-notebook.treatment.edit';
    }
