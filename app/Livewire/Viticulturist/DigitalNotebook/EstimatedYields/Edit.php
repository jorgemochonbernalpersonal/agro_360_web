...
class Edit extends Component
{
    ...
    public function updatedEstimatedYieldPerHectare() { $this->calculateTotalYield(); }
    public function updatedPlotPlantingId() { $this->calculateTotalYield(); $this->calculateFromSampling(); }
