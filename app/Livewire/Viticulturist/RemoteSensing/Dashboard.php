...
use App\Livewire\Viticulturist\RemoteSensing\Traits\HasPlotLoader;
...
{
    use HasAgriculturalCalculations, HasHistoricalAnalysis, HasPlotLoader, HasRecommendations;
