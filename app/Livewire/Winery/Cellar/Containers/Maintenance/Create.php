...
use App\Livewire\Concerns\WithContainerMaintenanceFormRules;
...
{
    use WithContainerMaintenanceFormRules, WithRoleAwareRedirect, WithToastNotifications;
    ...
    {
        return $this->maintenanceFormRules();
    }
}
