...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['error' => null, 'label' => null, 'hint' => null]));
...
foreach (array_filter((['error' => null, 'label' => null, 'hint' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="space-y-1">
    ...
    <div class="relative">
        <select <?php echo e($attributes->merge(['class' => $classes])); ?>>
            <?php echo e($slot); ?>
...
<?php /**PATH C:\Users\jorge\Desktop\cue\agro365_web\resources\views/components/select.blade.php ENDPATH**/ ?>