...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['error' => null, 'rows' => 4, 'label' => null, 'hint' => null]));
...
foreach (array_filter((['error' => null, 'rows' => 4, 'label' => null, 'hint' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="space-y-1">
    ...
    <textarea rows="<?php echo e($rows); ?>" <?php echo e($attributes->merge(['class' => $classes])); ?>><?php echo e($slot); ?></textarea>
...
<?php /**PATH C:\Users\jorge\Desktop\cue\agro365_web\resources\views/components/textarea.blade.php ENDPATH**/ ?>