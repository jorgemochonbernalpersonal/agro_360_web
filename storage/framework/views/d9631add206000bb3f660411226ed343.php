...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-card','data' => ['title' => 'Editar Cuadrilla','description' => 'Modifica la información de la cuadrilla','icon' => $icon,'iconColor' => 'from-[var(--color-agro-blue)] to-blue-700','backUrl' => route('viticulturist.personal.show', $crew)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Editar Cuadrilla','description' => 'Modifica la información de la cuadrilla','icon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($icon),'icon-color' => 'from-[var(--color-agro-blue)] to-blue-700','back-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('viticulturist.personal.show', $crew))]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-section','data' => ['title' => 'Información Básica','color' => 'blue']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Información Básica','color' => 'blue']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-actions','data' => ['cancelUrl' => route('viticulturist.personal.show', $crew),'submitLabel' => 'Guardar Cambios']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['cancel-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('viticulturist.personal.show', $crew)),'submit-label' => 'Guardar Cambios']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\Users\jorge\Desktop\cue\agro365_web\resources\views/livewire/viticulturist/personal/edit.blade.php ENDPATH**/ ?>